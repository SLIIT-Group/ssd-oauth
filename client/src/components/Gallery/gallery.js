...
const Gallery = () => {
  ...
  const loadFiles = (token) => {
    ...
    axios
      .post(`http://localhost:5000/googleDrive/readDrive`, body)
      .then((data) => {
        if (data) {
          console.log(data);
          setFiles(data.data);
  ...
  const handleDelete = (id) => {
    ...
    axios
      .post(`http://localhost:5000/googleDrive/deleteFile/${id}`, body)
      .then((data) => {
        if (data) {
                  ...
                  <div className="row col-md-12 p-0 m-0">
                    ...
                    <div className="col-md-5 justify-content-end text-center">
                      ...
                      <button
                        ...
                        onClick={() => handleDownload(item.webContentLink)}
                      >
                        <strong>Download</strong>
                      </button>
                      <button
                        className="btn btn-danger mt-1 col-md-12"
