                            ...
                            <div className="col-md-4">
                                <div className="footer">
                                    <div className="footer-logo">
                                        <a className="logo" href="#"><img src="./img/logo.png" alt=""/></a>
                                    </div>
                                    <p>This is a demonstration of how to improve web security with OAuth</p>
                                    <ul className="footer-contact">
                                        <li><i className="fa fa-map-marker"></i> SLIIT, New Kandy Road, Malabe
                                        </li>
                                        <li><i className="fa fa-phone"></i> +94 76 7 611 379</li>
                                        <li><i className="fa fa-envelope"></i> sliitgroup19@gmail.com</li>
                                    </ul>
                                </div>
                            </div>
